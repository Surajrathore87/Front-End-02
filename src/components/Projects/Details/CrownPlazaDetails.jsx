...
function CrownPlazaDetails() {
  ...
  const amenitiesData = [
    ...
    {
      title: 'NUMBER OF SHOWROOMS',
      subtitle: '150 ',
      icon: '/images/projects-icons/ashapurna-anmol/number-of-villas.svg',
    },
    {
      title: 'ADDRESS',
      subtitle: 'Near circuit house, Jaisalmer road, Barmer',
  ...
  const lowerGroundFloorPlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-1.jpg',
    },
  ];
  const groundFloorPlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-2.jpg',
    },
  ];
  const firstFloorPlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-3.jpg',
    },
  ];
  const secondToFifthGroundFloorPlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-4.jpg',
    },
  ];
  const lowerPentHousePlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-5.jpg',
    },
  ];
  const terraceFlorePlan = [
    {
      imageSrc: '/images/projects/Crawn-Plaza-6.jpg',
    },
  ];
  ...
  return (
    ...
    <FsLightbox
        toggler={lightboxController.toggler}
        sources={[
          '/images/projects/crawn-plaza/1.jpg',
          '/images/projects/crawn-plaza/2.jpg',
          '/images/projects/crawn-plaza/3.jpg',
          '/images/projects/crawn-plaza/4.jpg',
          '/images/projects/crawn-plaza/5.jpg',
          '/images/projects/crawn-plaza/6.jpg',
          '/images/projects/crawn-plaza/7.jpg',
          '/images/projects/crawn-plaza/8.jpg',
        ]}
              ...
              >
                <div className="d-md-flex">
                  ...
                  <div className="high-field-content">
                    <h1 className="fs-30 fw-600 m-0">Ashapurna Crown Plaza</h1>
                    <p className="text-color fw-400 fs-16">
                    QC39+767, Jaisalmer Highway, near Shivam hospital, Baldev Nagar, Barmer, Rajasthan 344001
                      <a
                        target={'blank'}
                        href="https://www.google.com/maps/dir//Ashapurna+Crown+Plaza+QC39%2B767+Jaisalmer+Highway,+near+Shivam+hospital,+Baldev+Nagar+Barmer,+Rajasthan+344001/@25.7531054,71.418086,15z/data=!4m8!4m7!1m0!1m5!1m1!1s0x39443b8f951e5a77:0x129f3153fd24eb11!2m2!1d71.418086!2d25.7531054"
              ...
              <div className="detail-overview pe-lg-5">
                <div>
                  ...
                  <p className="text-color fs-16 fw-400 lh-30 mb-3">
                    Ashapurna Crown Plaza is group’s debut project in Bramer, the oil city of Rajasthan, located on NH 15 near circuit house. The Crown Plaza complex houses aesthetically designed flats, shops and showroom equipped with all ultra modern amenities. The complex consists of lower basement, G+7 stories and basement. Crown Plaza offers 48 flats with options of 2, 3 & 4 BHK formats, 150 showrooms/shops and 31 kiosks of various sizes. It is Barmer’s first well-planned residential-cum-commercial complex with a right perspective for a life of perfections.
                  </p>
                </div>
                <div>
          ...
          <div className="row">
            ...
            <div className="col-lg-5">
              <div className="master-plan-img p-3 p-lg-4 mb-3 mb-lg-0 text-center">
                <img src="/images/projects/Crown Plaza-masterplan.jpg " alt="Master Plan" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
                    ...
                    <Nav className="floor-tabs text-center d-block">
                      ...
                      <Nav.Item className="d-inline-block mb-lg-3 mx-2">
                        <Nav.Link
                          ...
                          eventKey="four"
                        >
                          Second to Fifth Ground Floor Plan
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item className="d-inline-block mb-lg-3 mx-2">
                        <Nav.Link
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={lowerGroundFloorPlan} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Tab.Pane eventKey="two">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={groundFloorPlan} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Tab.Pane eventKey="three">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={firstFloorPlan} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Tab.Pane eventKey="four">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={secondToFifthGroundFloorPlan} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Tab.Pane eventKey="five">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={lowerPentHousePlan} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <Tab.Pane eventKey="six">
                      ...
                      >
                        <div className="row">
                          ...
                          <div className="col-lg-6 d-flex align-items-center">
                            <div className="my-lg-5 py-lg-5 w-100 project-slider">
                              <PlansSlider imageSrc={terraceFlorePlan} />
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="row">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/1.jpg'} width={345} height={250} alt="Photo Gallery" />
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/2.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/3.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/4.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/5.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/6.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/7.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
            ...
            <Col lg={3} md={6}>
              <div className="gallery-image mt-3 position-relative mt-lg-4 p-2 text-center">
                <Image src={'/images/projects/crawn-plaza/8.jpg'} width={345} height={250} alt="Photo Gallery" />
                <div className="gallery-overlay position-absolute w-100 h-100 align-items-center justify-content-center top-0 start-0">
...
export default CrownPlazaDetails;
