            ...
            <div className="col-lg-8 mb-lg-0 mb-3">
              <div className="event-detail-box bg-white overflow-hidden">
                <div className="event-main-img text-center">
                  <img src="/images/sections/monsoon-meet.webp" alt="Event Image" className="img-fluid" />
                </div>
                <div className="p-lg-4 p-3">
                  <h2 className="blue-color-2 fs-26 fw-600 mb-15">Monsoon meet at Club Heritage</h2>
                  <ul className="list-unstyled d-lg-flex">
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      ...
                      <span className="ps-2">10th Jul 2022</span>
                    </li>
                    <li className="text-color fs-15 me-lg-3 mb-2">
                  ...
                  <div className="text-color fs-14 lh-24">
                    <p>
                      Monsoon meet and get together was celebrated at Club Heritage of Ashapurna Heritage on 10 July.
                      The families and visiting clients enjoyed the evening before the arrival of monsoon season.
                      Children were seen swimming, playing and entertaining themselves with fun activities. Resident’s
                      of ashapurna and plot owners as well as new clients were also invited to attend the evening and
                      grab the best deals on villas and plots. Ashapurna’s sales team was also present there to showcase
                      the villas and modern amenities of the clubhouse and perspective of upcoming Ashapurna projects.
                    </p>
                    <p>
                      Ashapurna Heritage is a modern township with all the luxurious amenities, sample villas are also
                      ready and nearly 30+ families are currently residing there. The township has a 5-star clubhouse,
                      swimming pool, indoor and outdoor games, temple, gardens, clock tower, commercial complex and much
                      more .
                    </p>
                  </div>
