            ...
            <div className="col-lg-8 mb-lg-0 mb-3">
              <div className="event-detail-box bg-white overflow-hidden">
                <div className="event-main-img text-center">
                  <img src="/images/sections/daink-bhaskar.webp" alt="Event Image" className="img-fluid" />
                </div>
                <div className="p-lg-4 p-3">
                  <h2 className="blue-color-2 fs-26 fw-600 mb-15">
                    Danik Bhaskar Real Estate Expo 2022: Ashapurna Buildcon Limited
                  </h2>
                  <ul className="list-unstyled d-lg-flex">
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      ...
                      <span className="ps-2">24th - 25th Sept 2022</span>
                    </li>
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      <FontAwesomeIcon width={17} icon={faMapMarkerAlt} className="golden-color" />
                      <span className="ps-2">Hotel Shre Ram Excellency, Ratanada, Jodhpur</span>
                    </li>
                  </ul>
                  <div className="text-color fs-14 lh-24">
                    <p>
                      The two-day Dainik Bhaskar Mega Property Expo-2022 was organized on 24 & 25 September 2022. The
                      Mega Property Expo began on the 24 & 25 September 2022 Saturday at Hotel Shre Ram Excellency,
                      Ratanada, Jodhpur. A large number of visitors attended the expo on the very first day itself. The
                      expo will offer a plethora of property options to the customers under one roof. Ashapurna Buildcon
                      has also participated in the Danik Bhaskar real estate expo 2022 and grabbed all the customer’s
                      attention with their luxurious projects at prime locations in Rajasthan.
                    </p>
                    <p>
                      In the two-day expo, peoples looking to buy a home got plenty of options to buy commercial,
                      residential plots, villas, flats at affordable rates in Ashapurna’s various project at prime
