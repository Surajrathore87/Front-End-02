            ...
            <div className="col-lg-8 mb-lg-0 mb-3">
              <div className="event-detail-box bg-white overflow-hidden">
                <div className="event-main-img text-center">
                  <img src="/images/sections/independence-day.webp" alt="Event Image" className="img-fluid" />
                </div>
                <div className="p-lg-4 p-3">
                  <h2 className="blue-color-2 fs-26 fw-600 mb-15">
                    Independence Day Celebration at Ashapurna Buildcon
                  </h2>
                  <ul className="list-unstyled d-lg-flex">
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      ...
                      <span className="ps-2">15th Aug 2022</span>
                    </li>
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      <FontAwesomeIcon width={17} icon={faMapMarkerAlt} className="golden-color" />
                      <span className="ps-2">Ashapurna Buildcon’s Head office</span>
                    </li>
                  </ul>
                  <div className="text-color fs-14 lh-24">
                    <p>
                      Independence day is a national festival and it is one of the most important days in the history of
                      our nation. As August 15 is a national holiday for the offices and educational institutions, it is
                      our responsibility to spend some time celebrating it.
                    </p>
                    <p>
                      15 August celebration at Ashapurna Buildcon’s Head office. Flag hoisting has been done by
                      respected CMD Shree Karan Singh Uchiyarda sir and Director Mr. HarshVardhan Singh Uchiyarda sir of
