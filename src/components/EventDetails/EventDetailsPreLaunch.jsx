            ...
            <div className="col-lg-8 mb-lg-0 mb-3">
              <div className="event-detail-box bg-white overflow-hidden">
                <div className="event-main-img text-center">
                  <img src="/images/sections/prelaunch-event.webp" alt="Event Image" className="img-fluid" />
                </div>
                <div className="p-lg-4 p-3">
                  <h2 className="blue-color-2 fs-26 fw-600 mb-15">
                    Pre launching of Ashapurna NRI : Channel partner’s meet
                  </h2>
                  <ul className="list-unstyled d-lg-flex">
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      ...
                      <span className="ps-2">25th Sept 2022</span>
                    </li>
                    <li className="text-color fs-15 me-lg-3 mb-2">
                      <FontAwesomeIcon width={17} icon={faMapMarkerAlt} className="golden-color" />
                      <span className="ps-2">Ashapurna Heritage, Airport Road, Jodhpur</span>
                    </li>
                  </ul>
                  <div className="text-color fs-14 lh-24">
                    <p>
                      The Channel Partners Meet for NRI pre launching proved to be a significant event for Ashapurna
                      Buildcon Ltd. The event which was inaugurated with an inspiring speech by Director of company Mr.
                      Harshvardhan Singh. The event witnessed a footfall of more than 100 channel partners. The speech
                      by Mr. Vijay Vinayak ( GM Sales) added another layer of motivation for the attendees. The Channel
                      Partners schemes announced were received with great enthusiasm by our esteemed guests. After
                      felicitation, the event was concluded with a delectable dinner.
                    </p>
                    <p>
                      It was an honor and a pleasure meeting all the channel partners participating in the event. We are
                      grateful to the partners for taking the time out of their busy schedules and making time for us.
                      Together with our channel partners we look forward to scaling new heights in 2022!
                    </p>
                  </div>
